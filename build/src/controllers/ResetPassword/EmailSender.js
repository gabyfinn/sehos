...
exports.sendGoogleEmailUser = exports.sendEmailIvitation = exports.sendEmailInstructions = void 0;
...
const sendEmailInstructions = (email, subject, id, user) => {
...
exports.sendEmailInstructions = sendEmailInstructions;
const sendEmailIvitation = (email, subject) => {
    const receiver = [{ email }];
    transporter.sendTransacEmail({
        sender,
        to: receiver,
...
exports.sendEmailIvitation = sendEmailIvitation;
const sendGoogleEmailUser = (email, subject) => {
    const receiver = [{ email }];
    transporter.sendTransacEmail({
        sender,
        to: receiver,
...
exports.sendGoogleEmailUser = sendGoogleEmailUser;
